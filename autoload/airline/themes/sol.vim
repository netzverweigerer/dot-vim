...
let s:N1 = [ '#343434' , '#a0a0a0' , 246 , 235 ]
let s:N2 = [ '#343434' , '#b3b3b3' , 246 , 235 ]
let s:N3 = [ '#343434' , '#c7c7c7' , 246 , 235 ]
...
let g:airline#themes#sol#palette.normal_modified = {
      \ 'airline_c': [ '#ffffff' , '#ff6868' , 246 , 125 , '' ] ,
      \ }


let s:I1 = [ '#eeeeee' , '#09643f' , 251 , 235  ]
let s:I2 = [ '#343434' , '#a3a3a3' , 237 , 235 ]
let s:I3 = [ '#343434' , '#b0b0b0' , 237 , 235 ]
...
let g:airline#themes#sol#palette.insert_modified = {
      \ 'airline_c': [ '#343434' , '#ffdbc7' , 237 , 125 , '' ] ,
      \ }
let g:airline#themes#sol#palette.insert_paste = {
      \ 'airline_a': [ s:I1[0]   , '#09643f' , s:I1[2] , 130 , '' ] ,
      \ }
...
let s:V1 = [ '#ffff9a' , '#ff6003' , 237 , 248 ]
let s:V2 = [ '#343434' , '#a3a3a3' , 237 , 248 ]
let s:V3 = [ '#343434' , '#b0b0b0' , 237 , 248 ]
...
let s:IA = [ '#777777' , '#c7c7c7' , 237 , 248 , '' ]
...
let g:airline#themes#sol#palette.inactive_modified = {
      \ 'airline_c': [ '#ff3535' , '' , 237 , '' , '' ] ,
       \ }

let g:airline#themes#sol#palette.tabline = {
      \ 'airline_tab':      ['#343434', '#b3b3b3',  237, 248, ''],
      \ 'airline_tabsel':   ['#ffffff', '#004b9a',  237, 248 , ''],
      \ 'airline_tabtype':  ['#343434', '#a0a0a0',  237, 248, ''],
      \ 'airline_tabfill':  ['#343434', '#c7c7c7',  237, 248, ''],
      \ 'airline_tabmod':   ['#343434', '#ffdbc7',  237, 248, ''],
      \ }
